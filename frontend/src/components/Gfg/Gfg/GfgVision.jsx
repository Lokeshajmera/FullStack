...
const GfgVision = () => {
    return (
        <section className="relative bg-white rounded-3xl shadow-xl shadow-slate-200/50 p-8 md:p-12 overflow-hidden border border-slate-100">
            ...
            <div className="absolute top-0 right-0 w-64 h-64 bg-cyan-50 rounded-full blur-3xl -mr-20 -mt-20 opacity-60"></div>

            <div className="relative z-10">
                <div className="flex items-center space-x-4 mb-8">
                    <div className="w-12 h-12 bg-cyan-100 rounded-xl flex items-center justify-center text-cyan-600 shadow-inner">
                        <Eye size={28} />
                    </div>
