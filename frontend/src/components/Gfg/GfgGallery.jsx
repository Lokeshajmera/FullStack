            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {placeholders.map((item) => (
                    <motion.div
                        ...
                        className="aspect-video bg-white dark:bg-slate-800 rounded-2xl overflow-hidden relative shadow-sm hover:shadow-[0_0_15px_rgba(6,182,212,0.2)] transition-shadow border border-slate-300 dark:border-slate-700 hover:border-cyan-500/50"
                    >
                        <img
                        ...
                        />
                        <div className="absolute inset-0 flex items-center justify-center text-slate-600 dark:text-slate-400 font-medium bg-white dark:bg-slate-800 z-[-1]">
