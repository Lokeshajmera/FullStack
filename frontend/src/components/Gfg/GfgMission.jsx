...
const GfgMission = () => {
    return (
        <section className="relative bg-slate-100/80 dark:bg-slate-900/80 rounded-3xl shadow-lg p-8 md:p-12 overflow-hidden border border-slate-300 dark:border-slate-800">
            ...
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-blue-900/20 rounded-full blur-3xl -ml-20 -mb-20 opacity-60"></div>

            <div className="relative z-10">
                <div className="flex items-center space-x-4 mb-8">
                    <div className="w-12 h-12 bg-blue-900/40 rounded-xl flex items-center justify-center text-blue-400 border border-blue-800/50 shadow-inner">
                        <Target size={28} />
                    </div>
                    <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white">MISSION</h2>
                </div>
                ...
                >
                    <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed space-y-4">
